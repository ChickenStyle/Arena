...
public class SwordUpgradeGui {
	public SwordUpgradeGui(Player player) {
		...
		fmeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&f&lFire Aspect &r&e&lI"));
		ArrayList<String> flamelore = new ArrayList<>();
		flamelore.add(ChatColor.translateAlternateColorCodes('&', "&fCost: &e" + Config.getIneger("fireaspectprice") + "©"));
		...
		pmeta.setDisplayName(ChatColor.translateAlternateColorCodes('&', "&f&lSharpness &r&e&lI"));
		ArrayList<String> powerlore = new ArrayList<>();
		powerlore.add(ChatColor.translateAlternateColorCodes('&', "&fCost: &e" + Config.getIneger("sharpnessprice") + "©"));
		...
		Inventory gui = Bukkit.createInventory(null, 45 , ChatColor.AQUA + "" + ChatColor.BOLD + "Sword Upgrades");
